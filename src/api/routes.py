...
async def create_ticket(ticket_data: TicketCreate) -> Dict[str, Any]:
    """
    Create a new ticket
...
async def run_pipeline(ticket_id: str) -> Dict[str, Any]:
    """
...
async def get_ticket_audit(ticket_id: str) -> Dict[str, Any]:
    """
...
async def get_ticket_interactions(ticket_id: str) -> Dict[str, Any]:
    """
...
async def get_ticket_agent_states(ticket_id: str) -> Dict[str, Any]:
    """
